...
namespace OpenDxp\Bundle\AdminBundle\Handler\Misc\GetIconList;
...
{
    public function __invoke(GetIconListPayload $payload): GetIconListResult
    {
        $publicDir = OPENDXP_WEB_ROOT . '/bundles/opendxpadmin';
        $iconDir = $publicDir . '/img';

        $icons = match ($payload->type) {
