...
namespace OpenDxp\Bundle\AdminBundle\Handler\Settings\UpdateThumbnail;

use Exception;
use OpenDxp\Model\Asset;
use OpenDxp\Model\Exception\ConfigWriteException;

final class UpdateThumbnailHandler
{
    public function __invoke(UpdateThumbnailPayload $payload): void
    {
