...
namespace OpenDxp\Bundle\AdminBundle\Handler\Document\GetDocTypesByType;

use OpenDxp\Model\Document;
use OpenDxp\Model\Document\DocType;
use Symfony\Component\HttpKernel\Exception\BadRequestHttpException;

final class GetDocTypesByTypeHandler
{
    public function __invoke(GetDocTypesByTypePayload $payload): GetDocTypesByTypeResult
    {
