...
final class GetAssetDataHandler
{
    ...
    public function __construct(
        ...
        private readonly ElementResponseNormalizer $elementResponseNormalizer,
    ...
    public function __invoke(int $id, string $requestSchemeAndHost): GetAssetDataResult
    {
        ...
        $this->elementResponseNormalizer->normalize($asset, $data, static::class);

        $this->applyAdminStyle($asset, ElementAdminStyleEvent::CONTEXT_EDITOR, $data);
    ...
    private function applyAdminStyle(Asset $asset, int $context, array &$data): void
    {
        $event = new ElementAdminStyleEvent($asset, new AdminStyle($asset), $context);
