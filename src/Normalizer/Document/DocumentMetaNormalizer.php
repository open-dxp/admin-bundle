...
final class DocumentMetaNormalizer implements ElementResponseNormalizerInterface
{
    ...
    public function normalize(ElementInterface $element, array &$data, array $context = []): void
    {
        ...
        $data['userPermissions'] = $element->getUserPermissions();
        $data['idPath'] = ElementService::getIdPath($element);
        $data['php'] = [
            'classes' => [$element::class, ...array_values(class_parents($element))],
