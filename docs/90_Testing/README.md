...
│   ├── Handler/              # Handler tests (e.g. login link handlers)
│   ├── Permissions/          # Permission model tests
│   └── Security/             # Security service tests (e.g. TrustedLoginLinkHostResolver)
└── Support/
    ├── Helper/               # Codeception module helpers
    ├── Test/                 # Shared test cases (e.g. LoginLinkHostTestCase for login link host tests)
